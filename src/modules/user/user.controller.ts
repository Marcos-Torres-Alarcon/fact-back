...
export class UserController {
  ...
  async findByEmail(@Param('email') email: string): Promise<User> {
    try {
      this.logger.log(
        `Recibida solicitud para obtener usuario por email: ${email}`
      )
  ...
  async updateRole(
    ...
    try {
      this.logger.log(
        `Recibida solicitud para actualizar rol de usuario: ${id}`
      )
  ...
  async updateStatus(
    ...
    try {
      this.logger.log(
        `Recibida solicitud para actualizar estado de usuario: ${id}`
      )
